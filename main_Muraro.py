...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataname", default="./ziscDesk-single-cell-data/Muraro", type=str)
    parser.add_argument("--pretrain_epochs", default=300, type=int)
    parser.add_argument("--maxiter", default=500, type=int)
    parser.add_argument("--threshold_2", default=0.7,type=float)
    ...
    # Clustering training
    Cluster_predicted=model.alt_train(y, epochs=args.maxiter, centers=centers,threshold_2=args.threshold_2,k_cc=args.k_cc)
