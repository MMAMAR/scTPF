...
if __name__ == "__main__":
    ...
    parser.add_argument("--threshold_2", default=0.8,type=float)
    parser.add_argument("--k_cc", default=6, type=int)
    parser.add_argument("--gpu_option", default="1")
    ...
    # Clustering training
    Cluster_predicted=model.alt_train(y, epochs=args.maxiter, centers=centers,n_update=2,threshold_2=args.threshold_2,k_cc=args.k_cc,zeta=0.8,k_outlier=60)
