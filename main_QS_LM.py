...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataname", default="./ziscDesk-single-cell-data/Quake_Smart-seq2_Limb_Muscle", type=str)
    ...
    parser.add_argument("--gpu_option", default="4")
    ...
    adata = sc.AnnData(x)
    adata.obs['Group'] = y
    adata = normalize(adata, copy=True, highly_genes=1000, size_factors=True, normalize_input=True, logtrans_input=True)
    count = adata.X
