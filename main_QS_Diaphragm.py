...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataname", default="./ziscDesk-single-cell-data/Quake_Smart-seq2_Diaphragm", type=str)
    parser.add_argument("--pretrain_epochs", default=300, type=int)
    parser.add_argument("--maxiter", default=160, type=int)
    parser.add_argument("--threshold_2", default=0.86,type=float)
    parser.add_argument("--k_cc", default=4, type=int)
    ...
    # Clustering training
    Cluster_predicted=model.alt_train(y, epochs=args.maxiter, centers=centers,n_update=8,threshold_2=args.threshold_2,k_cc=args.k_cc,zeta=0.8,k_outlier=120)#0.8 120
